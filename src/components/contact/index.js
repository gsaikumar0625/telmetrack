...
const Contact = () => {
  ...
  return (
    <>
      <Heading heading={'Contact'} links={links} />
        ...
        text-start mt-2">
              <div>
                <h1 class="text-primaryColor mt-12 mb-8 font-extrabold"
                  style={{ fontSize: 40 }}>Contact</h1>
              </div>

              <div className='relative w-full min-h-screen p-8 bg-[#fafafa] overflow-hidden flex items-center justify-center'>
